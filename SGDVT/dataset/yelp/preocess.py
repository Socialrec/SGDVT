...
df = pd.read_csv('user_business.dat', sep='\t', dtype=int)
df.rename(columns={'business': 'item'}, inplace=True)
df['rating']=1
print(df)


Socialnet = pd.read_csv('user_user.dat', sep='\t', dtype=int)
print(Socialnet)
